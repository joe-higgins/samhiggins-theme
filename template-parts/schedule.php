      ...
      <div class="slider">
        <div class="slider-box">
          <h3>Friday February 22, 2019</h3>
            <a href="#">
              <img src="<?php bloginfo('template_url'); ?>/images/met-guild.png" alt="">
            </a>
  ...
  <div class="sliderv uk-position-relative uk-visible-toggle uk-light" tabindex="-1">
      ...
      <ul class="slider-box uk-slider-items uk-child-width-1-1@s uk-grid" uk-height-viewport="offset-top: true; offset-bottom: 50">
          <li class="uk-transition-toggle" tabindex="0">
              <div class="uk-card uk-card-default">
                  <div class="uk-card-media-top">
                      <img src="<?php bloginfo('template_url'); ?>/images/bsologo_hires.jpg" alt="">
                  </div>
          ...
          <li class="uk-transition-toggle" tabindex="0">
              <div class="uk-card uk-card-default">
                  <div class="uk-card-media-top">
                      <img src="<?php bloginfo('template_url'); ?>/images/zamir.png" alt="">
                  </div>
                  <div class="uk-card-body">
          ...
          <li class="uk-transition-toggle" tabindex="0">
              <div class="uk-card uk-card-default">
                  <div class="uk-card-media-top">
                      <img src="<?php bloginfo('template_url'); ?>/images/northeastern.png" alt="">
                  </div>
                  <div class="uk-card-body">
          ...
          <li class="uk-transition-toggle" tabindex="0">
              <div class="uk-card uk-card-default">
                  <div class="uk-card-media-top">
                      <img src="<?php bloginfo('template_url'); ?>/images/bcm.png" alt="">
                  </div>
                  <div class="uk-card-body">
          ...
          <li class="uk-transition-toggle" tabindex="0">
              <div class="uk-card uk-card-default">
                  <div class="uk-card-media-top">
                      <img src="<?php bloginfo('template_url'); ?>/images/falmouth.png" alt="">
                  </div>
                  <div class="uk-card-body">
          ...
          <li class="uk-transition-toggle" tabindex="0">
              <div class="uk-card uk-card-default">
                  <div class="uk-card-media-top">
                      <img src="<?php bloginfo('template_url'); ?>/images/un.png" alt="">
                  </div>
                  <div class="uk-card-body">
